...
class IoCmd(metaclass=Metaclass_IoCmd):
    ...
    def __init__(self, **kwargs):
        ...
        self.io_cmd_enable = kwargs.get('io_cmd_enable', bool())
        ...
        self.io_cmd_dis_charge = kwargs.get('io_cmd_dis_charge', bool())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.io_cmd_enable != other.io_cmd_enable:
            return False
        ...
        if self.io_cmd_speaker != other.io_cmd_speaker:
            return False
        if self.io_cmd_dis_charge != other.io_cmd_dis_charge:
            return False
        return True
    ...
    @builtins.property
    def io_cmd_enable(self):
        """Message field 'io_cmd_enable'."""
        return self._io_cmd_enable

    @io_cmd_enable.setter
    def io_cmd_enable(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_cmd_enable' field must be of type 'bool'"
        self._io_cmd_enable = value
    ...
    @builtins.property
    def io_cmd_dis_charge(self):
        """Message field 'io_cmd_dis_charge'."""
        return self._io_cmd_dis_charge

    @io_cmd_dis_charge.setter
    def io_cmd_dis_charge(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'io_cmd_dis_charge' field must be of type 'bool'"
        self._io_cmd_dis_charge = value
