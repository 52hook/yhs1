...
bool yhs_can_interfaces__msg__io_cmd__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("yhs_can_interfaces.msg._io_cmd.IoCmd", full_classname_dest, 36) == 0);
  }
  yhs_can_interfaces__msg__IoCmd * ros_message = _ros_message;
  {  // io_cmd_enable
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_cmd_enable");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_cmd_enable = (Py_True == field);
    Py_DECREF(field);
  }
  ...
  {  // io_cmd_dis_charge
    PyObject * field = PyObject_GetAttrString(_pymsg, "io_cmd_dis_charge");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->io_cmd_dis_charge = (Py_True == field);
    Py_DECREF(field);
  }
...
PyObject * yhs_can_interfaces__msg__io_cmd__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("yhs_can_interfaces.msg._io_cmd");
  ...
  {  // io_cmd_enable
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_cmd_enable ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_cmd_enable", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // io_cmd_dis_charge
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->io_cmd_dis_charge ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "io_cmd_dis_charge", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
