...
struct CtrlFb_
{
  ...
  explicit CtrlFb_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
    ...
    {
      this->ctrl_fb_gear = 0;
      this->ctrl_fb_velocity = 0.0f;
      this->ctrl_fb_steering = 0.0f;
      this->ctrl_fb_mode = 0;
    }
  }
  ...
  using _ctrl_fb_velocity_type =
    float;
  _ctrl_fb_velocity_type ctrl_fb_velocity;
  using _ctrl_fb_steering_type =
    float;
  _ctrl_fb_steering_type ctrl_fb_steering;
  using _ctrl_fb_mode_type =
    uint8_t;
  ...
  Type & set__ctrl_fb_velocity(
    const float & _arg)
  {
    this->ctrl_fb_velocity = _arg;
    return *this;
  }
  Type & set__ctrl_fb_steering(
    const float & _arg)
  {
    this->ctrl_fb_steering = _arg;
    return *this;
  }
  Type & set__ctrl_fb_mode(
    const uint8_t & _arg)
  {
    this->ctrl_fb_mode = _arg;
    return *this;
  }
  ...
  bool operator==(const CtrlFb_ & other) const
  {
    ...
    if (this->ctrl_fb_velocity != other.ctrl_fb_velocity) {
      return false;
    }
    if (this->ctrl_fb_steering != other.ctrl_fb_steering) {
      return false;
    }
    if (this->ctrl_fb_mode != other.ctrl_fb_mode) {
      return false;
    }
    return true;
  }
