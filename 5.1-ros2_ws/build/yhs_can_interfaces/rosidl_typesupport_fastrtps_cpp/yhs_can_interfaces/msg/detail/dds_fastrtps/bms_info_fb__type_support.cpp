...
#include "yhs_can_interfaces/msg/detail/bms_info_fb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yhs_can_interfaces::msg::BmsInfoFb & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yhs_can_interfaces::msg::BmsInfoFb & ros_message)
{
  // Member: bms_info_voltage
  cdr >> ros_message.bms_info_voltage;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces::msg::BmsInfoFb;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yhs_can_interfaces::msg::BmsInfoFb *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yhs_can_interfaces::msg::BmsInfoFb *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BmsInfoFb__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yhs_can_interfaces::msg::BmsInfoFb *>(
...
static size_t _BmsInfoFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BmsInfoFb(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BmsInfoFb__callbacks = {
...
static rosidl_message_type_support_t _BmsInfoFb__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BmsInfoFb__callbacks,
...
{
  return &yhs_can_interfaces::msg::typesupport_fastrtps_cpp::_BmsInfoFb__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yhs_can_interfaces, msg, BmsInfoFb)() {
  return &yhs_can_interfaces::msg::typesupport_fastrtps_cpp::_BmsInfoFb__handle;
}
