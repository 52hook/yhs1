...
#include "yhs_can_interfaces/msg/detail/ctrl_fb__rosidl_typesupport_fastrtps_c.h"
...
using _CtrlFb__ros_msg_type = yhs_can_interfaces__msg__CtrlFb;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CtrlFb__ros_msg_type * ros_message = static_cast<const _CtrlFb__ros_msg_type *>(untyped_ros_message);
  // Field name: ctrl_fb_gear
  {
    cdr << ros_message->ctrl_fb_gear;
  }

  // Field name: ctrl_fb_velocity
  {
    cdr << ros_message->ctrl_fb_velocity;
  }

  // Field name: ctrl_fb_steering
  {
    cdr << ros_message->ctrl_fb_steering;
  }

  // Field name: ctrl_fb_mode
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CtrlFb__ros_msg_type * ros_message = static_cast<_CtrlFb__ros_msg_type *>(untyped_ros_message);
  // Field name: ctrl_fb_gear
  {
    cdr >> ros_message->ctrl_fb_gear;
  }
...
static uint32_t _CtrlFb__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_yhs_can_interfaces__msg__CtrlFb(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yhs_can_interfaces__msg__CtrlFb;
    is_plain =
      (
...
static size_t _CtrlFb__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_yhs_can_interfaces__msg__CtrlFb(
...
static message_type_support_callbacks_t __callbacks_CtrlFb = {
...
static rosidl_message_type_support_t _CtrlFb__type_support = {
