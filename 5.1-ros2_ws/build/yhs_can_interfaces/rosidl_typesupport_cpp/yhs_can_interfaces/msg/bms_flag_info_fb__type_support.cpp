...
static const _BmsFlagInfoFb_type_support_symbol_names_t _BmsFlagInfoFb_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yhs_can_interfaces, msg, BmsFlagInfoFb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yhs_can_interfaces, msg, BmsFlagInfoFb)),
  }
};
...
{
  return &::yhs_can_interfaces::msg::rosidl_typesupport_cpp::BmsFlagInfoFb_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yhs_can_interfaces, msg, BmsFlagInfoFb)() {
  return get_message_type_support_handle<yhs_can_interfaces::msg::BmsFlagInfoFb>();
}
